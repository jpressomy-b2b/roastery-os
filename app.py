...
st.markdown("""
    ...
    /* v5.8 LAYOUT LOCK: Absolute Right Column Anchor */
...
st.title("🔥 Jpresso Roastery Intelligence v171.0")
st.caption("The True A4 Matrix: Flawless Print Scaling & Universal Prompts")
...
with tab3:
    ...
    if st.button("🏅 Generate Formal Evaluation Certificate", use_container_width=True):
        if student_name and target_bean:
            ...
            st.markdown("---")
            # Set Streamlit iframe height larger to accommodate the exact 1123px A4 screen scaling
